  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="InventoryRequests">Employee Inventory Requests</a></li> 
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding" style="margin-top:10px;">
                ...
                <a href="FilterInventory?inventorytype1=Approved">

                    <div class="col-sm-2"><div class="colorbox" style="background-color:#80cbc4; clear:both; cursor: pointer;" ></div><div class="colorboxtext" style="cursor: pointer;">Item Returned</div></div></a>
                ...
                <table id="example1" class="table table-bordered table-hover" style="padding-top:30px;">
                    <thead>
                        <tr>
                                ...
                                <tr id="row_<?=$i?>" style="background-color:<?=$trb?>;">
                                    ...
                                    <td>                                        
                                        ...
                                        <?php }elseif($list['InventoryInDate']!='0000-00-00 00:00:00'){ ?>
                                            <div style="cursor: pointer;" data-toggle="modal" data-target="#modal-default"><img src='dist/img/inward.png' style="width:20px; height: 20px;" onclick="return setinventoryid('<?=$list['InventoryID']?>','in');" title="Request for Return"></div>
                                        ...
                                        <?php }else{ ?>
                                            <div style="cursor: pointer;" data-toggle="modal" data-target="#modal-default"><img src='dist/img/outward.png' onclick="return setinventoryid('<?=$list['InventoryID']?>','out',<?=$list['InventoryItemID']?>);" title="Waiting For Out Approval"></div>
                                        <?php } ?>
                                    </td>
                                </tr>
                            <?php } ?>
    ...
    function appleave(){
        ...
        $.ajax({
            ...
            error: function(response){
                swal("Inventory Changes Made Successful", "You clicked the button!", "success").then(okay => {
                if (okay) {
                window.location.href = "InventoryRequests";
                }
                });
