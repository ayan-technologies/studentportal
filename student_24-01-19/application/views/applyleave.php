                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9" style="margin-top: 7px;">
                          <div class="col-sm-2"><input type="radio" class="col-sm-2" name="informed" id="informedyes" value="1" > &nbsp; Yes </div>
                          <div class="col-sm-2"><input type="radio" class="col-sm-2" name="informed" id="informedno" value="0" > &nbsp; No </div>
                      </div>
                    </div>
                  </div>
...
;        if(document.getElementById('informedyes').checked==true){
        ...
        $.ajax({
            ...
            success: function(response,data){
                ...
                $('#showleave').hide();
                $('#showpermission').hide();
                document.getElementById('informedyes').checked=false;document.getElementById('informedno').checked=false;
...
function Checkleave(){
      ...
      var pto = $('#totime').val();
              ...
              type: 'POST',
              data: {fdate:val,type:type,LeavePermissionDate:pdate,LeavePermissionFrom:pfrom,LeavePermissionTo:pto},
