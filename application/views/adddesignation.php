  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="CompensationLeave">Add Designation </a></li> 
      </ol>
    </section>
   <div id="cont"></div>
    <!-- Main content -->
              ...
              <div class="box box-info">
                ...
                <form id="myForm1" name="myForm1" method="post" class="form-horizontal">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                           ...
                           onchange="showemp(this.value);" style="width: 100%;">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="designame" name="noday" placeholder="Designation Name">
                      </div>
                    </div>
                  </div>
                  <!-- /.box-body -->
                  <div class="box-footer twoToneCenter">
                    ...
                    <button type="button" class="btn btn-info pull-right twoToneButton" onclick="return adddesignation();" >Submit</button>
                  </div>
                  <!-- /.box-footer -->
                </form>
              </div>
...
function adddesignation(){
  ...
  var designame = document.getElementById('designame').value;
      ...
      $.ajax({
            url:'Employee/AddDesignationData',
            type: 'POST',
           // dataType: 'json',
            data: {DesignationDepartment:department, DesignationName:designame},
               success: function(response){ 

                $('#imgload').hide();

               swal("Designation Added Successfully", "You clicked the button!", "success").then(okay => {
            if (okay) {
