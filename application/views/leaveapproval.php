...
if($this->session->userdata['userdetails']->EmployeeUserRole!=1 && $this->session->userdata['userdetails']->EmployeeUserRole!=4){
            ...
            <div class="box-body table-responsive no-padding" style="clear:both;">
              <table id="" class="table table-bordered">
                ...
                <tbody>
                  ...
                  <th>
                    <div class="fa fa-edit" data-toggle="modal" data-target="#modal-cancel" onclick="return setleaveid();" style="cursor: pointer;"></div>
                    <!-- <div class="fa fa-edit" data-toggle="modal" data-target="#modal-default" onclick="return setleaveid();" style="cursor: pointer;"> -->
                  </th>
                </tr>
                <tr>
                  <th>2</th>
