...
<section class="content">
    <!-- <?php if($this->session->userdata['userdetails']->EmployeeUserRole==1){?> <?php } ?> -->
      ...
      <div class="row">
        ...
        <div class="col-lg-2 col-xs-6" onclick='window.location.href="Assignment";'>
      ...
      <?php } if($this->session->userdata['userdetails']->EmployeeUserRole==1 || $this->session->userdata['userdetails']->EmployeeUserRole==2 ){?>
        ...
        <!-- <div class="col-lg-2 col-xs-6">
          <div class="small-box" style="text-align: center">
            ...
            <div class="btn-group">
                    <button type="button" class="btn btn-default font_family" onclick='window.location.href="ProfileMenu";'>View Profile 
                    </button>
                </div>
          </div>
        </div> -->
